...
PCA 2D vizuelizacija (Po 3 slike za svaki algoritam), Sacuvanih klastera (Po 3 cluster.csv fajla za svaki algoritam) i jednog summary.csv fajla za svaki algoritam u kom su tabelarno navedene glavne karakteristikr i parametri algoritma kao i rezultati koriscenih metrika za evaluaciju.
